...
class DrawdownManager:
    ...
    def update(self, timestamp: datetime, portfolio_value: float) -> None:
        ...
        if len(self.daily_pnl) > 0:
            ...
            daily_loss_pct = abs(daily_pnl) / self.peak_value if self.peak_value > 0 else 0
    ...
    def calculate_historical_drawdowns(
    ...
    def get_risk_adjusted_position_size(
        ...
        """
        drawdown = current_drawdown if current_drawdown is not None else self.current_drawdown
