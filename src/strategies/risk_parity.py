...
class RiskParityStrategy(BaseStrategy):
    ...
    def calculate_position_sizes(
        ...
        total_target_vol = self._calculate_portfolio_volatility(target_positions, latest_prices)
    ...
    def _calculate_portfolio_volatility(
        ...
        try:
            # Calculate weights
            total_value = sum(positions[s] * prices[s] for s in positions if s in prices)
            ...
            weights = np.array([
                ...
                if symbol in positions and symbol in prices else 0.0
